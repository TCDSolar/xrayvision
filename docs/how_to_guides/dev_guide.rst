...
repository visit the repository page at https://github.com/TCDSolar/xrayvision (make sure you are logged
...
.. code:: bash
    ...
    git clone https://github.com/<username>/xrayvision.git

It is also advisable to configure the upstream remote at this point

.. code:: bash

    git remote add upstream https://github.com/TCDSolar/xrayvision
