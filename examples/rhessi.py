...
hdul = fits.open('https://hesperia.gsfc.nasa.gov/rhessi_extras/visibility_fits_v2/'
...
vis = Visibility(vis=vis_data['obsvis']*vunit, u=vis_data['u']/apu.arcsec, v=vis_data['v']/apu.arcsec,
